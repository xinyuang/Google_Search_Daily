...
import {refreshCategoryNews, requestBookMarkAdd, requestBookMarkDel} from "../../data/modules/news";
...
class QueryNews extends React.Component<Props, State> {
    ...
    componentDidMount() {
        this.props.refreshCategoryNews();
    }
...
export default connect(mapStateToProps, { refreshCategoryNews, requestBookMarkAdd,requestBookMarkDel })(QueryNews);
